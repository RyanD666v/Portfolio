...
const AnimatedImage = ({ targetRef, frontSrc, backSrc, alt = '' }: AnimatedImageProps) => {
  ...
  const frontRotateY = useTransform(scrollYProgress, [0, 0.95, 1], [0, 180, 180])

  const backRotateY = useTransform(scrollYProgress, [0, 0.95, 1], [180, 360, 360])
  ...
  return (
    <motion.div
      ...
      transition={{ duration: 0.95, delay: 1.6, ease: [0.25, 0.1, 0.25, 1] }}
      style={{
        width,
        height,
        perspective: 1200
